...
public:
    ...
    RHReliableDatagram(RHGenericDriver& driver, int32_t thisAddress = 0);
    ...
    bool sendtoWait(uint8_t* buf, uint8_t len, int32_t address);
    ...
    bool recvfromAck(uint8_t* buf, uint8_t* len, int32_t* from = NULL, int32_t* to = NULL, uint8_t* id = NULL, uint8_t* flags = NULL);
    ...
    bool recvfromAckTimeout(uint8_t* buf, uint8_t* len,  uint16_t timeout, int32_t* from = NULL, int32_t* to = NULL, uint8_t* id = NULL, uint8_t* flags = NULL);
...
protected:
    ...
    void acknowledge(uint8_t id, int32_t from);
